...
import DateRange from "../../components/UI/wrappers/DateRange";
import { formatCurrency } from "../../libs";
import ViewTransactions from "../../components/UI/ViewTransactions";
import AddTransactions from "../../components/UI/addTransactions";
    ...
    <>
      <div className="w-full py-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-10">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
            ...
            <button
              ...
              className="py-1.5 px-2 rounded text-white bg-black dark:via-violet-800 flex items-center justify-center gap-2 border"
            >
              <MdAdd size={22} />
            ...
            <button
              ...
              className="flex items-center gap-2 text-black dark:text-gray-300 cursor-pointer"
            >
        ...
        <div className="overflow-x-auto mt-5">
          {data?.length === 0 ? (
            <div className="w-full flex items-center justify-center py-10 text-gray-600 dark:text-gray-700 text-1g">
                    ...
                    >
                      ...
                      <td className="py-4 px-2">
                        <div className="flex flex-col w-56 md:w-auto">
                          <p className="text-base 2xl:text-1g text-black dark:text-gray-400 line-clamp-2">
                            {item.description}
                          </p>
                        </div>
                      </td>
                      ...
                      <td className="py-4 text-black dark:text-gray-400 text-base font-medium">
                        ...
                        >
                          {item?.type === "Income" || item?.source === "Income"
                            ? "+"
                            : "-"}
                        </span>
